...
def mlp(x_, y_, hidden_layers=(5, 5), activation_='relu'):
    model_ = MLPClassifier(hidden_layer_sizes=hidden_layers, random_state=0, max_iter=250, activation=activation_)
    model_.fit(x_, y_)
    return model_
